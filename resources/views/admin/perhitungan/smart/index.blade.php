        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                @if ($filterTA)
                    ...
                    <form id="calculate-form" action="{{ route('admin.perhitungan.smart.calculate') }}" method="POST" class="d-none">
                        @csrf
                    ...
                    <form id="recalculate-form" action="{{ route('admin.perhitungan.smart.calculate') }}" method="POST" class="d-none">
                        @csrf
                        <input type="hidden" name="id_ta" value="{{ $filterTA }}">
                        @foreach ($filterKelas as $kelasId)
                            <input type="hidden" name="kelas[]" value="{{ $kelasId }}">
        ...
        @if ($hasCalculation)
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.perhitungan.smart.steps', ['id_ta' => $filterTA, 'kelas' => $filterKelas]) }}"
