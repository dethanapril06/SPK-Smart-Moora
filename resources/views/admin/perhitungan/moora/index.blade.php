                ...
                <form action="{{ route('admin.perhitungan.moora.index') }}" method="GET">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <small class="text-muted d-block mt-1">Perhitungan MOORA dijalankan per kelas (X.1, X.2, dst.).</small>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            ...
                            <small class="text-muted">
                                Perhitungan MOORA dihitung mandiri per masing-masing kelas (Peringkat 1..N di setiap kelas).
                            </small>
                        </div>
        ...
        @if ($hasCalculation)
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 pb-2">
                    <div>
                        <h5 class="mb-1">Hasil Perangkingan MOORA (Per Angkatan &amp; Per Kelas)</h5>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.perhitungan.finalis.moora.index', ['tahun_ajaran' => $filterTA, 'semester' => $filterSemester]) }}" class="btn btn-sm btn-success">
                            <i class="tf-icons bx bx-medal"></i> 10 Besar MOORA (Finalis)
                        </a>
                    </div>
                </div>
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                        ...
                                                        <table class="table table-hover table-sm mb-0">
                                                            <thead class="table-light">
                                                                <tr>
                                                                    ...
                                                                    <th>NISN</th>
                                                                    <th>Nama Siswa</th>
                                                                    <th class="text-center bg-label-success" style="width: 140px;">Skor MOORA (Yi)</th>
                                ...
                                @else
                                    <div class="text-center py-5 text-muted">
                                        ...
                                        Belum ada data perhitungan MOORA untuk Angkatan <strong>Kelas {{ $tingkatKey }}</strong>
                                    </div>
                                @endif
        ...
        @elseif ($filterTA)
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">
                        Silakan pilih kelas dan klik tombol <strong>"Hitung Sekarang"</strong> untuk melakukan perhitungan MOORA per masing-masing kelas.
                    </p>
                </div>
            </div>
        @endif
