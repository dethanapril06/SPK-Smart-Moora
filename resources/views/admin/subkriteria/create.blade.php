...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header">Form Tambah Sub Kriteria</h5>
            <div class="card-body">
                            ...
                            <select id="id_kriteria" name="id_kriteria"
                                ...
                                @foreach ($kriteria as $k)
                                    <option value="{{ $k->id_kriteria }}"
                                        {{ old('id_kriteria') == $k->id_kriteria ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="nama_subkriteria" name="nama_subkriteria"
                                ...
                                placeholder="Contoh: Sangat Baik" value="{{ old('nama_subkriteria') }}" autofocus />
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="nilai_awal" name="nilai_awal"
                                        ...
                                        value="{{ old('nilai_awal', 0) }}" min="0" step="0.01" />
                                </div>
                                @error('nilai_awal')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="nilai_akhir" name="nilai_akhir"
                                        ...
                                        value="{{ old('nilai_akhir', 0) }}" min="0" step="0.01" />
                                </div>
                                @error('nilai_akhir')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="number" id="bobot_subkriteria" name="bobot_subkriteria"
                                ...
                                value="{{ old('bobot_subkriteria', 0) }}" min="0" step="0.01" />
                        </div>
