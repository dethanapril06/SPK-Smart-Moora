    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb breadcrumb-style1 mb-0">
                ...
                <li class="breadcrumb-item active">Edit Jenis Pelanggaran</li>
            </ol>
        </nav>

        <div class="card">
            <h5 class="card-header">Form Edit Jenis Pelanggaran</h5>
            <div class="card-body">
                <form action="{{ route('admin.jenispelanggaran.update', $jenispelanggaran->id_jenis_pelanggaran) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <select id="kategori_pelanggaran" name="kategori_pelanggaran"
                                ...
                                @foreach ($kategoriList as $kat)
                                    <option value="{{ $kat }}"
                                        {{ old('kategori_pelanggaran', $jenispelanggaran->kategori_pelanggaran) == $kat ? 'selected' : '' }}>
                                        {{ str_replace('_', ' ', $kat) }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <textarea id="nama_pelanggaran" name="nama_pelanggaran"
                                ...
                                rows="3" autofocus>{{ old('nama_pelanggaran', $jenispelanggaran->nama_pelanggaran) }}</textarea>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="number" id="bobot_poin" name="bobot_poin"
                                ...
                                value="{{ old('bobot_poin', $jenispelanggaran->bobot_poin) }}" min="0"
                                step="1" />
                        </div>
                        @error('bobot_poin')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
