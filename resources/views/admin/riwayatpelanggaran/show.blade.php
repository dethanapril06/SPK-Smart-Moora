                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                                ...
                                <td>:
                                    @if ($riwayatpelanggaran->jenisPelanggaran)
                                        <span class="badge bg-label-primary">
                                            {{ str_replace('_', ' ', $riwayatpelanggaran->jenisPelanggaran->kategori_pelanggaran) }}
                                        </span>
                                    @endif
                                </td>
                            </tr>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <a href="{{ route('admin.riwayatpelanggaran.edit', $riwayatpelanggaran->id_riwayat) }}"
