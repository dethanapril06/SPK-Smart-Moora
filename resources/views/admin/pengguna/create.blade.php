            ...
            <div class="card-body">
                <form action="{{ route('admin.pengguna.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <select id="level" name="level" class="form-select @error('level') is-invalid @enderror">
                                ...
                                <option value="Wali Kelas" {{ old('level') == 'Wali Kelas' ? 'selected' : '' }}>Wali Kelas
                                </option>
                                <option value="Kepala Sekolah" {{ old('level') == 'Kepala Sekolah' ? 'selected' : '' }}>
                    ...
                    <div class="alert alert-info">
                        ...
                        Password default untuk pengguna baru adalah: <strong>password</strong>
                    </div>
