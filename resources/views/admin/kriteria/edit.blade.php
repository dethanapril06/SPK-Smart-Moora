...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.kriteria.update', $kriterium->id_kriteria) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control @error('kode_kriteria') is-invalid @enderror"
                                        ...
                                        value="{{ old('kode_kriteria', $kriterium->kode_kriteria) }}" autofocus />
                                </div>
                                @error('kode_kriteria')
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select id="jenis_kriteria" name="jenis_kriteria"
                                        ...
                                        <option value="Benefit"
                                            {{ old('jenis_kriteria', $kriterium->jenis_kriteria) == 'Benefit' ? 'selected' : '' }}>
                                            Benefit (Semakin Tinggi Semakin Baik)</option>
                                        <option value="Cost"
                                            {{ old('jenis_kriteria', $kriterium->jenis_kriteria) == 'Cost' ? 'selected' : '' }}>
                                            Cost (Semakin Rendah Semakin Baik)</option>
                                    </select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="bobot" name="bobot"
                                        ...
                                        value="{{ old('bobot', $kriterium->bobot) }}" min="0" max="100"
                                        step="0.01" />
                                </div>
                                @error('bobot')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
