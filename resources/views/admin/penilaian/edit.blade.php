...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="filter_ta" class="form-select"
                            onchange="window.location.href='{{ route('admin.penilaian.edit', $siswa->id_siswa) }}?ta=' + this.value">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.penilaian.update', $siswa->id_siswa) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save me-1"></i> Update Penilaian
                        </button>
                    </div>
                </form>
            </div>
