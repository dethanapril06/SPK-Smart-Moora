...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header">Form Edit Tahun Ajaran</h5>
            <div class="card-body">
                <form action="{{ route('admin.tahunajaran.update', $tahunajaran->id_ta) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_ajaran', $tahunajaran->tahun_ajaran) }}" autofocus />
                        </div>
                        @error('tahun_ajaran')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Semester terkait akan dikelola otomatis.</div>
                    </div>
