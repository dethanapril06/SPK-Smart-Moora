        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo text-body fw-bolder ms-2">SPK Siswa Berprestasi</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('admin/perhitungan/smart*') ? 'active' : '' }}">
              <a href="{{ route('admin.perhitungan.smart.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calculator"></i>
                <div data-i18n="SMART">SMART</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('admin/perhitungan/moora*') ? 'active' : '' }}">
              <a href="{{ route('admin.perhitungan.moora.index') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('admin/tahunajaran*') ? 'active' : '' }}">
              <a href="{{ route('admin.tahunajaran.index') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('admin/subkriteria*') ? 'active' : '' }}">
              <a href="{{ route('admin.subkriteria.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-list-ul"></i>
                <div data-i18n="Sub Kriteria">Sub Kriteria</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('admin/jenispelanggaran*') ? 'active' : '' }}">
              <a href="{{ route('admin.jenispelanggaran.index') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('admin/riwayatpelanggaran*') ? 'active' : '' }}">
              <a href="{{ route('admin.riwayatpelanggaran.index') }}" class="menu-link">
