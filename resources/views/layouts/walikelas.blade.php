      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('walikelas.dashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder fs-5 ms-2">SPK Siswa Berprestasi</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('wali-kelas/dashboard') ? 'active' : '' }}">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Data Kelas Saya</span>
            </li>
            <li class="menu-item {{ request()->is('wali-kelas/kelas*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.kelas.index') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('wali-kelas/tahunajaran*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.tahunajaran.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calendar"></i>
                <div data-i18n="Tahun Ajaran">Tahun Ajaran</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('wali-kelas/kriteria*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.kriteria.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-slider"></i>
                <div data-i18n="Kriteria">Kriteria</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('wali-kelas/subkriteria*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.subkriteria.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-list-ul"></i>
                <div data-i18n="Sub Kriteria">Sub Kriteria</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('wali-kelas/jenispelanggaran*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.jenispelanggaran.index') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('wali-kelas/riwayatpelanggaran*') ? 'active' : '' }}">
              <a href="{{ route('walikelas.riwayatpelanggaran.index') }}" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="https://ui-avatars.com/api/?background=0D8ABC&color=fff&name={{ urlencode(auth()->user()->name) }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
