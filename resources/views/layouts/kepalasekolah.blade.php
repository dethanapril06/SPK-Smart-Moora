      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('kepalasekolah.dashboard') }}" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ request()->is('kepala-sekolah/dashboard') ? 'active' : '' }}">
              <a href="{{ route('kepalasekolah.dashboard') }}" class="menu-link">
            ...
            <li class="menu-item {{ request()->is('kepala-sekolah/kelas*') ? 'active' : '' }}">
              <a href="{{ route('kepalasekolah.kelas.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-book"></i>
                <div data-i18n="Kelas">Kelas</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('kepala-sekolah/kriteria*') ? 'active' : '' }}">
              <a href="{{ route('kepalasekolah.kriteria.index') }}" class="menu-link">
