            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{ route('kepalasekolah.report.moora.pdf', ['tahun_ajaran' => $filterTA, 'semester' => $filterSemester, 'source' => $source, 'kelas' => $filterKelas]) }}"
                            class="btn btn-sm btn-danger" target="_blank">
                            <i class="bx bxs-file-pdf"></i> Export PDF
                        </a>
                        <a href="{{ route('kepalasekolah.report.moora.excel', ['tahun_ajaran' => $filterTA, 'semester' => $filterSemester, 'source' => $source, 'kelas' => $filterKelas]) }}"
