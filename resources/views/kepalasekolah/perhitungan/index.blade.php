...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <!-- Filter -->
        <div class="card mb-4">
            <h5 class="card-header">Filter Hasil Perangkingan</h5>
            <div class="card-body">
                <form action="{{ route('kepalasekolah.perhitungan.index') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select" name="source">
                                @if (count($sourceList) > 0)
                                    ...
                                    @endforeach
                                @else
                                    <option value="admin" {{ $source == 'admin' ? 'selected' : '' }}>Admin (Semua Siswa)
                                    </option>
                                @endif
                            </select>
                        </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title m-0">
                        <i class="bx bx-trophy text-warning"></i> Hasil Ranking — {{ $sourceName }}
                    </h5>
                    <div class="btn-group">
        ...
        @else
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">
                        @if ($filterTA)
                            Belum ada hasil perhitungan dari sumber yang dipilih untuk tahun ajaran ini.
                        @else
