        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('kepalasekolah.siswa.index') }}">Siswa</a></li>
                    <li class="breadcrumb-item active">Siswa Lulus</li>
                </ol>
            </nav>
            <a href="{{ route('kepalasekolah.siswa.lulus.pdf', request()->query()) }}" class="btn btn-danger" target="_blank">
        ...
        <div class="card mb-4">
            <div class="card-header pb-2 d-flex align-items-center justify-content-between">
                ...
                @if ($search || $tahunLulus || $jenisKelamin)
                    <a href="{{ route('kepalasekolah.siswa.lulus') }}" class="btn btn-sm btn-outline-secondary">
                        <i class="bx bx-refresh me-1"></i> Reset Filter
                    </a>
                @endif
            </div>
            <div class="card-body">
                <form action="{{ route('kepalasekolah.siswa.lulus') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-5">
