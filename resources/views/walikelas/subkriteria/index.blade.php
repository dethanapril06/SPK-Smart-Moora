...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('walikelas.subkriteria.index') }}" method="GET">
                    ...
                    <tbody>
                        @forelse($subkriteria as $item)
                            <tr>
                                ...
                                <td><span class="badge bg-label-primary">{{ $item->kriteria->kode_kriteria ?? '-' }}</span>
                                </td>
                                <td>{{ $item->nama_subkriteria }}</td>
                                <td>{{ $item->nilai_awal }}</td>
                                <td>{{ $item->nilai_akhir }}</td>
                                <td><strong>{{ $item->bobot_subkriteria }}</strong></td>
                            </tr>
                        @empty
                            <tr>
