...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('walikelas.perhitungan.smart.index') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-5">
                ...
                @if ($filterTA)
                    ...
                    <form id="calculate-form" action="{{ route('walikelas.perhitungan.smart.calculate') }}" method="POST" class="d-none">
                        @csrf
                        <input type="hidden" name="id_ta" value="{{ $filterTA }}">
                        <input type="hidden" name="id_semester" value="{{ $filterSemester }}">
                    </form>
                    <form id="recalculate-form" action="{{ route('walikelas.perhitungan.smart.calculate') }}" method="POST" class="d-none">
                        @csrf
                        <input type="hidden" name="id_ta" value="{{ $filterTA }}">
                        <input type="hidden" name="id_semester" value="{{ $filterSemester }}">
                    </form>
        ...
        @if ($hasCalculation)
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5>Hasil Ranking SMART - {{ $kelas->nama_kelas }}</h5>
                    <div>
                        <a href="{{ route('walikelas.perhitungan.smart.steps', ['id_ta' => $filterTA, 'semester' => $filterSemester]) }}"
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center">Belum ada data perhitungan SMART</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
