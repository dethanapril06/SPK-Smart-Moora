...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('walikelas.perhitungan.index') }}" method="GET">
                    <div class="row g-3">
                        <div class="col-md-8">
                ...
                @if ($filterTA)
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group" role="group">
                            @if ($hasCalculation)
                                ...
                                <a href="{{ route('walikelas.perhitungan.compare', $filterTA) }}"
                    ...
                    <form id="recalculate-form" action="{{ route('walikelas.perhitungan.calculate') }}" method="POST"
                        class="d-none">
                        @csrf
                        <input type="hidden" name="id_ta" value="{{ $filterTA }}">
                    </form>
        ...
        @if ($hasCalculation)
            <div class="card">
                <h5 class="card-header">Hasil Ranking SMART & MOORA - {{ $kelas->nama_kelas }}</h5>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="{{ route('walikelas.perhitungan.steps', ['id_ta' => $filterTA, 'metode' => 'moora']) }}"
                    ...
                    <p class="text-muted">
                        @if ($filterTA)
                            @if ($studentsWithCompletePenilaian >= 2)
                                ...
                                MOORA untuk kelas {{ $kelas->nama_kelas }}.
                            @else
