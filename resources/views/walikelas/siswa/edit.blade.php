...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('walikelas.siswa.update', $siswa->id_siswa) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                                        id="nisn" name="nisn" value="{{ old('nisn', $siswa->nisn) }}" autofocus />
                                </div>
                                @error('nisn')
                            ...
                            <select id="id_ta" name="id_ta" class="form-select @error('id_ta') is-invalid @enderror">
                                ...
                                @foreach ($tahunAjaran as $ta)
                                    <option value="{{ $ta->id_ta }}"
                                        {{ old('id_ta', $siswa->id_ta) == $ta->id_ta ? 'selected' : '' }}>
