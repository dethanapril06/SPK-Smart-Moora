                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>: <span
                                        class="badge bg-label-{{ $siswa->jenis_kelamin == 'L' ? 'primary' : 'danger' }}">{{ $siswa->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('walikelas.siswa.index') }}" class="btn btn-secondary"><i
                                    class="bx bx-arrow-back me-1"></i> Kembali</a>
                            <a href="{{ route('walikelas.siswa.edit', $siswa->id_siswa) }}" class="btn btn-primary"><i
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar flex-shrink-0 me-3"><span class="avatar-initial rounded bg-label-primary"><i
                                        class="bx bx-list-check"></i></span></div>
                            <div><small class="text-muted d-block">Total Penilaian</small>
                                <h5 class="mb-0">{{ $siswa->penilaian->count() }}</h5>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="avatar flex-shrink-0 me-3"><span class="avatar-initial rounded bg-label-warning"><i
                                        class="bx bx-error"></i></span></div>
                            <div><small class="text-muted d-block">Riwayat Pelanggaran</small>
